...
public final class GameDrawer {
	...
	private final class Train implements GameDrawableTexture {
		...
		@Override
		public void loadTexture() {
			this.wagon.loadGLTexture(gl, context, R.drawable.texture_wagon, Texture.AspectRatio.BitmapOneToOne);
	...
	private final class Wheels implements GameDrawableTexture {
		...
		@Override
		public void loadTexture() {
			this.mediumWheel.loadGLTexture(gl, context, R.drawable.texture_wheel_medium, Texture.AspectRatio.BitmapOneToOne);
			this.largeWheel.loadGLTexture(gl, context, R.drawable.texture_wheel_large, Texture.AspectRatio.BitmapOneToOne);
			this.smallWheel.loadGLTexture(gl, context, R.drawable.texture_wheel_small, Texture.AspectRatio.BitmapOneToOne);
			this.wheelShaft.loadGLTexture(gl, context, R.drawable.texture_wheel_shaft, Texture.AspectRatio.BitmapOneToOne);
