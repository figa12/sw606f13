...
\subsubsection*{Initial Game Flow}
...
\todo{Skal billedet være en rigtig station og ikke en start station?}
\begin{figure}[H]
\centering
...
\end{figure}
\autoref{fig:finalresult} and \autoref{miniaturegame} shows the final result of the game design. \todo{skriv lige hvad miniaturegame billedet viser}
