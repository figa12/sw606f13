...
In \chapref{processweek2} it is explained how Tove Søby's version of the exercise work. We intend to keep the same principles of Tove Søby's exercise. We will start by given a short description of the important objects of the game.
\begin{description}
...
In order to mimic Tove Søby's version of the exercise we had to make the game customizable, this was achieved by adding a menu where it is possible to customize the pictograms and the category for each station. The menu and its functionality is explained later in \secref{designmenu}.
