...
In \secref{processweek2} it is explained how Tove's version of the exercise work. We intent to keep the same principles of Tove's exercise. We will start by given a short description of the important objects of the game.
...
%\subsubsection*{Initial Game Flow}% ser tosset ud med subsubsection lige før/efter description
...
\subsection{Final Game Design}\label{sec:finalgame}
