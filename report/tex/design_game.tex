...
In order to mimic Tove's version of the exercise we had to make the game customizable, this was achieved by adding a menu where Tove was able to customize the pictograms and the category for each station. The menu and its functionality is explained later in \secref{designmenu}.
During the design phase we agreed upon some constants of the game, the distance between the stations, the velocity of the train, etc. The constants in the game have all been approved of Tove. The constants and their values are shown in \appref{app:constants}.
