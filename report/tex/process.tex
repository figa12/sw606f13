...
It is now possible to drag and drop pictograms to different containers. In case a container is filled or the pictogram is released outside a container, the dragged pictogram snaps back to its original container.
...
We now have a sliding background that works, however we discovered that it is too slow, we discussed whether or not we should use \ac{opengles} instead. 
