...
When an application is run from he launcher\todo{Acronym goes here} the application receives a color that can be chosen in the launcher.\todo{ACRONYM} We use this color to set the overall color theme of the menu, meaning that whe whole menu will show in the chosen color from the launcher.\todo{acronym}
