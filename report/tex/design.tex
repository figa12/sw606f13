...
To keep the same look and feel throughout the whole \ac{giraf} project, we looked for inspiration in the projects from 2012. The WOMBAT \todo{mangler acronym} project had the same kind of customisation menu we were looking to make.\autoref{fig:wombat} 
